...
<%--<jsp:useBean id="distance" scope="session" type="java.lang.Double"/>--%>
<html>
<head>
    ...
    <div class="container px-4 pt-5" id="choix">
        ...
        <div class="row g-4 pt-5 row-cols-1 row-cols-lg-3">
            ...
            <div class="feature col text-center">
                ...
                <select class="form-select" data-live-search="true" aria-label="Default select example" name="ville1">
            ...
            <div class="feature col text-center">
                ...
                <select class="form-select" data-live-search="true" aria-label="Default select example" name="ville2">
                    <optgroup label="Code postal - Nom de commune">
                         <c:forEach items="${ selectVille }" var="ville" varStatus="index">
                             <option value="${ index.count }"><c:out value="${ ville.codePostal } - ${ ville.nomCommune }" /></option>
                         </c:forEach>
...
<%--                <h4><c:out value="${ distance } km(s)" /></h4>--%>
            </div>
            <div class="feature col"></div>
        </div>
    </div>
